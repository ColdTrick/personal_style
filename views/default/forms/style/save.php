<?php
	...
	$wallpaper_type = elgg_extract('wallpaper_type', $wallpaper_user_settings);
	$wallpaper_id = elgg_extract('wallpaper', $wallpaper_user_settings);

	echo elgg_view('input/hidden', array('name' => 'personal_style_selected_wallpaper'));
	echo elgg_view('input/hidden', array('name' => 'personal_style_selected_type', 'value' => $wallpaper_type));
		...
		<ol id="personal_style_wallpaper_selectable">
			...
			if ($wallpaper_list) {
				foreach($wallpaper_list as $wallpaper) {
					?>
					<li class="ui-widget-content <?php echo (($wallpaper == $wallpaper_id)?'ui-selected':''); ?> default" rel="<?php echo $wallpaper; ?>">
			...
			?>
			<li class="ui-widget-content personal_style_wallpapers_add <?php echo (($wallpaper_type == 'custom')?'ui-selected':''); ?>">
				...
				<img src="<?php echo elgg_get_site_url(); ?>mod/personal_style/wallpaper.php?guid=<?php echo elgg_get_logged_in_user_guid(); ?>" />
			</li>
		</ol>
